...
/**
 * min - MK returns the minimum of two size_t values
 * @a: first value
 * @b: second value
 *
...
/**
 * binary_search_helper - MK searches for a value in an integer array using a
...
/**
 * exponential_search - MK searches for a value in a sorted array of integers
